...
#include <vftr_mpi_ireduce_scatter_block.h>

void vftr_MPI_Ireduce_scatter_block_f082c(void *sendbuf, void *recvbuf, MPI_Fint *recvcount,
   ...
   int c_error = vftr_MPI_Ireduce_scatter_block(sendbuf,
                                                recvbuf,
                                                (int)(*recvcount),
                                                c_datatype,
                                                c_op,
