...
void vftr_MPI_Iallgatherv_f082c(void *sendbuf, MPI_Fint *sendcount, MPI_Fint *f_sendtype,
                                void *recvbuf, MPI_Fint *f_recvcounts, MPI_Fint *f_displs, 
                                MPI_Fint *f_recvtype, MPI_Fint *f_comm, MPI_Fint *f_request,
                                MPI_Fint *f_error) {
   ...
   int c_error = vftr_MPI_Iallgatherv(sendbuf,
                                      (int)(*sendcount),
                                      c_sendtype,
                                      recvbuf,
                                      c_recvcounts,
