...
MODULE vftr_mpi_waitsome_f082c_f08interface
#ifdef _MPI
   ...
   PUBLIC :: vftr_MPI_Waitsome_f082c

   INTERFACE

      SUBROUTINE vftr_MPI_Waitsome_f082c(f_incount, f_array_of_requests, &
                                         f_outcount, f_array_of_indices, &
                                         f_array_of_statuses, f_error) &
         BIND(C, name="vftr_MPI_Waitsome_f082c")
...
END MODULE vftr_mpi_waitsome_f082c_f08interface
