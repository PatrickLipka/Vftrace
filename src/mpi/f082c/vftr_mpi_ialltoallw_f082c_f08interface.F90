...
MODULE vftr_mpi_ialltoallw_f082c_f08interface
#ifdef _MPI
   ...
   PUBLIC :: vftr_MPI_Ialltoallw_f082c

   INTERFACE 

      SUBROUTINE vftr_MPI_Ialltoallw_f082c(sendbuf, f_sendcounts, f_sdispls, f_sendtypes, &
                                          recvbuf, f_recvcounts, f_rdispls, f_recvtypes, &
                                          f_comm, f_request, f_error) &
         BIND(C, name="vftr_MPI_Ialltoallw_f082c")
         IMPLICIT NONE
      ...
      END SUBROUTINE vftr_MPI_Ialltoallw_f082c
...
END MODULE vftr_mpi_ialltoallw_f082c_f08interface
