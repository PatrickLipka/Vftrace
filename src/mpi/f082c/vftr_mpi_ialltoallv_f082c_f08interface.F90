...
MODULE vftr_mpi_ialltoallv_f082c_f08interface
#ifdef _MPI
   ...
   PUBLIC :: vftr_MPI_Ialltoallv_f082c

   INTERFACE 

      SUBROUTINE vftr_MPI_Ialltoallv_f082c(sendbuf, f_sendcounts, f_sdispls, f_sendtype, &
                                          recvbuf, f_recvcounts, f_rdispls, f_recvtype, &
                                          f_comm, f_request, f_error) &
         BIND(C, name="vftr_MPI_Ialltoallv_f082c")
         IMPLICIT NONE
      ...
      END SUBROUTINE vftr_MPI_Ialltoallv_f082c
...
END MODULE vftr_mpi_ialltoallv_f082c_f08interface
