...
#include <vftr_mpi_testall.h>
  
void vftr_MPI_Testall_f082c(MPI_Fint *f_count, MPI_Fint *f_array_of_requests,
                            MPI_Fint *f_flag, MPI_F08_status *f_array_of_statuses,
                            MPI_Fint *f_error) {
...
//TODO:ENABLE   if (f_array_of_statuses != MPI_F08_STATUSES_IGNORE) {
