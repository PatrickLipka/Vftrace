...
SUBROUTINE MPI_Rget_accumulate_f08(origin_addr, origin_count, origin_datatype, &
   ...
   USE vftr_mpi_rget_accumulate_f082c_f08interface, &
      ONLY : vftr_MPI_Rget_accumulate_f082c
   ...
   CALL vftr_MPI_Rget_accumulate_f082c(origin_addr, origin_count, origin_datatype%MPI_VAL, &
