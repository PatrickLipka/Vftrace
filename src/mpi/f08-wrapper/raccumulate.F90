...
SUBROUTINE MPI_Raccumulate_f08(origin_addr, origin_count, origin_datatype, &
   ...
   USE vftr_mpi_raccumulate_f082c_f08interface, &
      ONLY : vftr_MPI_Raccumulate_f082c
   ...
   CALL vftr_MPI_Raccumulate_f082c(origin_addr, origin_count, origin_datatype%MPI_VAL, &
                                   target_rank, target_disp, target_count, &
