...
SUBROUTINE MPI_Ireduce_scatter_block_f08(sendbuf, recvbuf, recvcount, &
                                         datatype, op, comm, &
                                         request, error)
   USE vftr_mpi_ireduce_scatter_block_f082c_f08interface, &
      ONLY : vftr_MPI_Ireduce_scatter_block_f082c
   ...
   CALL vftr_MPI_Ireduce_scatter_block_f082c(sendbuf, recvbuf, recvcount, &
