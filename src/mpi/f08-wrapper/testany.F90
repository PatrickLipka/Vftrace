...
SUBROUTINE MPI_Testany_f08(count, array_orequests, index, flag, status, error)
   USE vftr_mpi_testany_f082c_f08interface, &
      ONLY : vftr_MPI_Testany_f082c
   ...
   CALL vftr_MPI_Testany_f082c(count, tmp_array_orequests, index, flag, status, tmperror)
