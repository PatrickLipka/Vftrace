...
SUBROUTINE MPI_Waitsome_f08(incount, array_orequests, outcount, &
                            array_oindices, array_ostatuses, error)
   USE vftr_mpi_waitsome_f082c_f08interface, &
      ONLY : vftr_MPI_Waitsome_f082c
   ...
   CALL vftr_MPI_Waitsome_f082c(incount, tmp_array_orequests, outcount, &
