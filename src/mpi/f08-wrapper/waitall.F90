...
SUBROUTINE MPI_Waitall_f08(count, array_orequests, array_of_statuses, error)
   USE vftr_mpi_waitall_f082c_f08interface, &
      ONLY : vftr_MPI_Waitall_f082c
   ...
   CALL vftr_MPI_Waitall_f082c(count, tmp_array_orequests, array_of_statuses, tmperror)
