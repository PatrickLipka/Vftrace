...
SUBROUTINE MPI_Waitany_f08(count, array_orequests, index, status, error)
   USE vftr_mpi_waitany_f082c_f08interface, &
      ONLY : vftr_MPI_Waitany_f082c
   ...
   CALL vftr_MPI_Waitany_f082c(count, tmp_array_orequests, index, status, tmperror)
